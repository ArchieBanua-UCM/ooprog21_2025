...
public class DebugFour4
{
   public static void main(String[] args)
   {
      ...
      trip1 = new DebugTrip(destinationCity); // 1-arg constructor
      trip2 = new DebugTrip(destinationCity, departureCity); // 2-arg constructor
      trip3 = new DebugTrip(destinationCity, departureCity, mode); // 3-arg constructor
